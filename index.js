...
const token = "6790501040:AAHVOGmKcvSFaMLHv61wER1Kh905mkYgT10";
...
bot.on("message",async(msg)=>{
        ...
        try {
            const response = await axios.get(
              `https://api.openweathermap.org/data/2.5/weather?q=${userInput}&appid=feb687a008ec5d21d928a44929a9333e
              `
            );
